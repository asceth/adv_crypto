...
-define(SHA256, 26).
-define(SHA256_INIT, 27).
-define(SHA256_UPDATE, 28).
-define(SHA256_FINAL, 29).
-define(SHA512, 30).
-define(SHA512_INIT, 31).
-define(SHA512_UPDATE, 32).
-define(SHA512_FINAL, 33).
...
control(Cmd, Data) ->
  Port = adv_crypto_server:client_port(),
